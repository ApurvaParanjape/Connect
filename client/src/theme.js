//basically setting up colors and setting for dark and light mode and font styles that will be used in further frontend development.
//color is denoted by a number.
...
//actual setup of dark light mode and font style
        ...
        palette: {
            ...
            ...(mode === "dark" ? {
                ...
                neutral: {
                    ...
                    mediumMain: colorToken.grey[300],
                    medium: colorToken.grey[400],
                ...
                neutral: {
                    ...
                    medium: colorToken.grey[300],
                    light: colorToken.grey[50],
                },
                background: {
                    default: colorToken.grey[1900],
